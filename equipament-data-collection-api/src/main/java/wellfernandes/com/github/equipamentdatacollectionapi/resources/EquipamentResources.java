...
public class EquipamentResources {
	...
	@GetMapping(value = "/{id}")
	public ResponseEntity<Equipament> findById(@PathVariable Long id) {
		Equipament equipament = equipamentService.findById(id);
		return ResponseEntity.ok().body(equipament);
	}
